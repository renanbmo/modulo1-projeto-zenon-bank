...
public class Main {
    public static void main(String[] args) {
        ...
        transactions.add(new Transaction(1L, Transaction.Type.PAYMENT, new BigDecimal("9839.64"),
                "C1231006815", new BigDecimal("170136.0"), new BigDecimal("160296.36"),
                "M1979787155", new BigDecimal("0.0"), new BigDecimal("0"),
                (byte) 0, (byte) 0));

        transactions.add(new Transaction(743L, Transaction.Type.CASH_OUT, new BigDecimal("850002.52"),
